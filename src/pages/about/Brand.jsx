        ...
        <section>
          ...
          <div className="row">
            <div className="col-12 col-md-8">
              ...
              <p>
                Yazdırma için çizim dosyaları için <a href="!#"  target="_blank" rel="noopener noreferrer">.EPS</a>, yayıncılık ve web için <a href="!#"  target="_blank" rel="noopener noreferrer">.SVG </a> yada <a href="!#"  target="_blank" rel="noopener noreferrer">.PNG</a> formatında indirilebilirsin.
              </p>
