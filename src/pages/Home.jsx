...
import { HomeSection, HomeLibrarySection } from "./../components/Styled"

const App = () => {
  return (
    <>
      <HomeSection>
        <SEO title="Hızlı ve kolay web sayfaları geliştirin" />
