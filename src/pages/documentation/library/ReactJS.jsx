    ...
    <>
      <BasePage info={obj}>
        ...
        <section>
          ...
          <p>
            React ile geliştirmekte olduğun projeye <strong>react-turkuaz</strong> paketini dahil ederek, Turkuaz'ın harika bileşenlerini kullanmaya başlayabilirsin. Detaylı doküman için;
          </p>

          <p className="mt-2">
            <a href="https://react.turkuazcss.com" className="button is-primary is-outline" target="_blank" rel="noopener noreferrer">
              react.turkuazcss.com
            </a>
          </p>
        </section>

        <template>
          //TODO: React dokümanına eklenecek section'lar
        </template>
        ...
        <section hidden>
          ...
          <p>
            <SyntaxHighlighter language="bash">
              {`npm install react-turkuaz`}
            </SyntaxHighlighter>
          </p>

          <p>
            <SyntaxHighlighter language="bash">
              {`yarn add react-turkuaz`}
            </SyntaxHighlighter>
          </p>
        </section>
        ...
        <section hidden>
          ...
          <p>
            <SyntaxHighlighter language="jsx">
              {
`import { Button } from "react-turkuaz"
import "turkuaz.min.css"

<Button variant="primary">Turkuaz</Button>`
}
            </SyntaxHighlighter>
          </p>
        </section>
