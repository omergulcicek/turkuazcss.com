...
class BasePage extends Component {  
  render () {
    const { title, desc, breadcrumb, content, editlink, pagination, children } = this.props
...

        {
          ...
          <Pagination>
...

            {
              ...
              <a href={editlink} class="tooltip" data-content="Bu sayfayı düzenle" target="_blank" rel="noopener noreferrer">
